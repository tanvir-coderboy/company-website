    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 m-auto">
                <form id="faqForm" action="{{ route('admin.testimonials.update',$data->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-12 p-1 mb-3">
                                    ...
                                    <input type="text" value="{{$data->review}}" name="review" id="review" class="form-control  @error('review') is-invalid @enderror" placeholder="Enter review">
                                    @error('review') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>

                                <div class="col-12 p-1 mb-3">
                                    <label for="review_text" class="form-label">Review Text</label>
                                    <textarea name="review_text" id="review_text" class="form-control  @error('review_text') is-invalid @enderror" rows="4" placeholder="Enter review text">{!!$data->review_text!!}</textarea>
                                ...
                                <div class="col-md-6 p-1 mb-3">
                                    ...
                                    <div class="mt-2">
                                        <img id="preview-image" 
                                            src="{{ $data->image ? Storage::url($data->image) : '' }}"  alt="Preview" width="70" height="60">
                                    </div>
                                </div>
