                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @can('edit user')
                                        <a href="{{ route('admin.faqs.edit', $item->id) }}" class="btn btn-sm btn-secondary" data-bs-toggle="tooltip" title="View"><i class="fa fa-eye"></i></a>
                                        <a href="{{ route('admin.faqs.edit', $item->id) }}" class="btn btn-sm btn-primary" data-bs-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
                                        @endcan
                                        @can('delete user')
...
<script>
    $(document).ready(function() {
        $('.status-toggle').on('change', function() {
            ...
            $.ajax({
                url: "{{ route('admin.faqs.status.update') }}",
                method: "POST",
                data: {
                    _token: "{{ csrf_token() }}",
                    id: id,
