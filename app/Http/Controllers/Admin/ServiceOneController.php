...
class ServiceOneController extends Controller
{
    ...
    {
        $data = ServiceOne::all();
        return view('admin.serviceone.index', compact('data'));
    }
    ...
    {
        return view('admin.serviceone.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        ServiceOne::create($data);

        return redirect()->route('admin.serviceone.index')->with('success', 'Data Create Successfully');
    }
    ...
    {
        $data = ServiceOne::findOrFail($id);
        return view('admin.serviceone.edit', compact('data'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('admin.serviceone.index')->with('message', 'Data Updated Successfully');
    }
    ...
    {
        $item = ServiceOne::findOrFail($request->id);
